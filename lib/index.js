...
const htmlTemplate =
  '<!DOCTYPE html><html lang="en-US"><head><meta charset="UTF-8" /><title>%{title}</title></head><body><h1>I am alive</h1><h3>%{date}</h3></body></html>';

const defaultHtmlVals = { title: "Containerized Status in NodeJS" };
